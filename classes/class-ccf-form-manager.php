		...
		<script type="text/html" id="ccf-single-line-text-template">
			...
			<div class="accordion-section <# if ( 'advanced' === startPanel ) { #>expanded<# } #>">
				...
				<div class="section-content">
					...
					<div>
						<label form="ccf-field-regular-expression-validator"><?php esc_html_e( 'Regular expression validator:', 'custom-contact-forms' ); ?></label>
						<input type="text" id="ccf-field-regular-expression-validator" class="field-regular-expression-validator" value="{{ field.regularExpressionValidator }}" />
					</div>
					<div>
						<label form="ccf-field-regular-expression-validator-message"><?php esc_html_e( 'Regular expression validator message:', 'custom-contact-forms' ); ?></label>
						<input type="text" id="ccf-field-regular-expression-validator-message" class="field-regular-expression-validator-message" value="{{ field.regularExpressionValidatorMessage }}" />
					</div>
				</div>
			</div>
		</script>
